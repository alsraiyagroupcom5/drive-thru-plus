...
- [x] Admin still asked to sign in when opening an order tracking link — fix staff detection
- [x] Full sweep: pages, forms, links, menus — fix bugs found
- [x] Completed/picked-up orders move to a "done" table at the bottom with date filters (today / yesterday / last 7 days / this month / specific date)
